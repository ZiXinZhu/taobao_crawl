...
@Component
public class StepOne extends AbstractStrategy implements IStrategy {
    @Autowired
    ...
    public void execut() {
        ...
        WebElement el= ieOperator.driver.findElements(By.className("tabs-mod__tab___1dUYL")).get(2);
        common(el);
    }
    @Override
