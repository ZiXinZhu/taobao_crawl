...
@Component
public class StepThree extends AbstractStrategy implements IStrategy {
    @Autowired
    ...
    public void execut() {
        ...
        WebElement el= ieOperator.driver.findElements(By.className("tabs-mod__tab___1dUYL")).get(3);
        common(el);
    }
    @Override
